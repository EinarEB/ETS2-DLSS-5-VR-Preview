...
technique ETS2_VortStereo < ui_label="ETS2 stereo motion (Vort)"; ui_tooltip="Independent motion histories for both eyes. Run before DLSS 5 Feed. Requires the matched-depth add-on."; > {
